...
.light-purple-background {
  background-color: #e0c3e5; /* Adjust as needed */
}

.lighter-purple-background {
  background-color: #f2e6f5; /* Adjust as needed */
}

/* Optional: Add some padding to the table cells for better visual appearance */
td {
